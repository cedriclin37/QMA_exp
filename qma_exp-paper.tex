...
\end{definition}
\begin{theorem}\label{thm:revpspace}[Bennett\cite{bennett89}]$\revPSPACE=\PSPACE$
\end{theorem}
...
Given as input a succinct encoding of $A$, a succinctly representable matrix, whose determinant is promised to be 0, 1, or -1. Moreover, each column of $A$ has at no more than two 1s.  Does $\det(A)$ vanish?
\end{definition}
