...
Given as input a succinct encoding of $A$, a succinctly representable sparse symmetric matrix with entries either 0, 1, or 2, whose determinant is promised to be $0$ or of magnitude at least $1/2^{\poly}$. Does $\det(A)$ vanish?
\end{definition}
