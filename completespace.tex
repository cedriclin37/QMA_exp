...
Our second result concerns the $\QMA$-complete Local Hamiltonian problem. We will show that if the promise gap is only exponentially small instead of polynomially small, the problem becomes $\PSPACE$-complete:
